...
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Compra_Medicamento` (`idCompra_Medicamento`, `Medicamentos_Código`, `Fecha_Compra`, `Unidades`, `Igic`, `Importe`) VALUES (11, Deprax, '2019-11-11', 1, 3.5, 10);
INSERT INTO `mydb`.`Compra_Medicamento` (`idCompra_Medicamento`, `Medicamentos_Código`, `Fecha_Compra`, `Unidades`, `Igic`, `Importe`) VALUES (22, Lizipadol, '2019-11-12', 2, 3.5, 16);
